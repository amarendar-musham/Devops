...
if [ ! $(which chef-server-ctl) ]; then
  ...
  chef-server-ctl user-create amar amarendar musham amar@kelly.com reds --filename amar.pem
  chef-server-ctl org-create kelly "kelly technolgies" --association_user amar --filename kelly-validator.pem
fi
